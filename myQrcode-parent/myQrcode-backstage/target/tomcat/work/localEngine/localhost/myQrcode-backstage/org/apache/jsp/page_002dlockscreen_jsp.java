...
public final class page_002dlockscreen_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath=request.getContextPath();
      ...
      out.write("\t\ttype: \"get\",\n");
      out.write("\t\tdata:{\"qr\":\"");
      out.print(request.getParameter("qr"));
      out.write("\",\"item\":\"");
      ...
      out.write("\t\turl: \"");
      out.print(basePath);
      out.write("/authentication/begin.action\",\n");
      out.write("\t\tdataType: \"json\",\n");
      out.write("\t\tsuccess: function(data, textStatus) {\n");
      out.write("\t\t\talert(\"fsdafsd\");\n");
      out.write("\t\t}\n");
      out.write("\t});\n");
      out.write("\twindow.location.href=\"");
      out.print(basePath);
      out.write("/authentication/end.action?item=");
      out.print(request.getParameter("item"));
      out.write("&qr=");
      out.print(request.getParameter("qr"));
      out.write("\";\n");
      ...
      out.write("\t\t\t\t\t\t\t<h2 class=\"name\">Welcome to use </h2>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<form onsubmit=\"return button();\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"text-center\" >\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary btn-block\" type=\"submit\">验  证</button>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</form>\n");
